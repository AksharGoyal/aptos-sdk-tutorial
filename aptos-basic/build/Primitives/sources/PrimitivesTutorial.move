...
module PrimitivesTutorial {
    ...
    #[view]
    public fun get_number(addr: address): u64 acquires ExampleData {
        borrow_global<ExampleData>(addr).number
    }
    ...
    public fun test_create_and_get_example_data(account: &signer) acquires ExampleData {
        ...
        let example_data_number = get_number(signer::address_of(account));
    ...
    public fun test_increment_number(account: &signer) acquires ExampleData {
        ...
        let new_number = get_number(signer::address_of(account));
